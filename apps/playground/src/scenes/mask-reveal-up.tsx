...
export default makeScene(function* (view) {
  ...
  view.add(
    <>
      ...
      <AnimatedText ref={ref} effect={MASK_REVEAL_UP} text="" fontSize={64} color="#ffd166" />
    </>,
  );
  ...
  yield* t.phrase("Designed to move.\nBuilt to focus.");
  yield* t.phrase("Quiet motion.\nStrong hierarchy.");
  yield* t.phrase("Premium feel.\nEvery frame.", { exitOn: "next-scene" });
