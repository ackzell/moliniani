...
import { buildEffectAnimation, PER_WORD_CROSSFADE, type TextEffectProps } from "../textEffects";


const _sfc_main = /*@__PURE__*/_defineComponent({
  __name: 'PerWordCrossfade',
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...PER_WORD_CROSSFADE.defaults,
    split: PER_WORD_CROSSFADE.target,
    progress: 0,
    fontSize: 32,
...
const anime = useSplitTextAnimation(
  el,
  () => {
    return { [props.split]: { class: `per-word-crossfade-${props.split}` } } as TextSplitterParams;
  },
  () => buildEffectAnimation(PER_WORD_CROSSFADE, props as TextEffectProps),
  {
    progress: "progress",
    units: () => props.split as SplitUnitOrWhole,
    text: () => props.text,
    staggerMode: () => PER_WORD_CROSSFADE.staggerMode,
  },
);
...
_sfc_main.__scopeId = "data-v-PerWordCrossfade";
const __style = "\n.per-word-crossfade[data-v-PerWordCrossfade] {\n  display: inline-block;\n  white-space: pre;\n}\n.per-word-crossfade[data-v-PerWordCrossfade] span {\n  display: inline-block;\n  will-change: transform, opacity, filter;\n}\n";
if (typeof document !== "undefined" && !document.getElementById("data-v-PerWordCrossfade")) {
  const __styleEl = document.createElement("style");
  __styleEl.id = "data-v-PerWordCrossfade";
