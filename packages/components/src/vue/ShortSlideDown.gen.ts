...
import { buildEffectAnimation, SHORT_SLIDE_DOWN, type TextEffectProps } from "../textEffects";


const _sfc_main = /*@__PURE__*/_defineComponent({
  __name: 'ShortSlideDown',
...
const anime = useSplitTextAnimation(
  el,
  () => {
    return { [props.split]: { class: `short-slide-down-${props.split}` } } as TextSplitterParams;
  },
  () => buildEffectAnimation(SHORT_SLIDE_DOWN, props as TextEffectProps),
  {
    progress: "progress",
...
_sfc_main.__scopeId = "data-v-ShortSlideDown";
const __style = "\n.short-slide-down[data-v-ShortSlideDown] {\n  display: inline-block;\n  white-space: pre;\n}\n.short-slide-down[data-v-ShortSlideDown] span {\n  display: inline-block;\n  will-change: transform, opacity, filter;\n}\n";
if (typeof document !== "undefined" && !document.getElementById("data-v-ShortSlideDown")) {
  const __styleEl = document.createElement("style");
  __styleEl.id = "data-v-ShortSlideDown";
