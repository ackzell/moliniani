...
import { buildEffectAnimation, KINETIC_CENTER_BUILD, type TextEffectProps } from "../textEffects";


const _sfc_main = /*@__PURE__*/_defineComponent({
  __name: 'KineticCenterBuild',
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...KINETIC_CENTER_BUILD.defaults,
    split: KINETIC_CENTER_BUILD.target,
    progress: 0,
    fontSize: 32,
...
const anime = useSplitTextAnimation(
  ...
  () => {
    return {
      [props.split]: { class: `kinetic-center-build-${props.split}` },
    } as TextSplitterParams;
  },
  () => buildEffectAnimation(KINETIC_CENTER_BUILD, props as TextEffectProps),
  {
    progress: "progress",
