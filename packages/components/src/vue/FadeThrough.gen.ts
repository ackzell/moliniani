...
import { buildEffectAnimation, FADE_THROUGH, type TextEffectProps } from "../textEffects";
...
const _sfc_main = /*@__PURE__*/_defineComponent({
  ...
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...FADE_THROUGH.defaults,
    split: FADE_THROUGH.target,
    progress: 0,
    fontSize: 32,
...
const anime = useSplitTextAnimation(
  el,
  () => {
    return { [props.split]: { class: `fade-through-${props.split}` } } as TextSplitterParams;
  },
  () => buildEffectAnimation(FADE_THROUGH, props as TextEffectProps),
  {
    progress: "progress",
    units: () => props.split as SplitUnitOrWhole,
    text: () => props.text,
    staggerMode: () => FADE_THROUGH.staggerMode,
  },
);
...
_sfc_main.__scopeId = "data-v-FadeThrough";
const __style = "\n.fade-through[data-v-FadeThrough] {\n  display: inline-block;\n  white-space: pre;\n}\n.fade-through[data-v-FadeThrough] span {\n  display: inline-block;\n  will-change: transform, opacity, filter;\n}\n";
if (typeof document !== "undefined" && !document.getElementById("data-v-FadeThrough")) {
  const __styleEl = document.createElement("style");
  __styleEl.id = "data-v-FadeThrough";
