...
import { buildEffectAnimation, BOTTOM_UP_LETTERS, type TextEffectProps } from "../textEffects";


const _sfc_main = /*@__PURE__*/_defineComponent({
  __name: 'BottomUpLetters',
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...BOTTOM_UP_LETTERS.defaults,
    split: BOTTOM_UP_LETTERS.target,
    progress: 0,
    fontSize: 32,
...
const anime = useSplitTextAnimation(
  el,
  () => {
    return { [props.split]: { class: `bottom-up-letters-${props.split}` } } as TextSplitterParams;
  },
  () => buildEffectAnimation(BOTTOM_UP_LETTERS, props as TextEffectProps),
  {
    progress: "progress",
    units: () => props.split as SplitUnitOrWhole,
    text: () => props.text,
    staggerMode: () => BOTTOM_UP_LETTERS.staggerMode,
  },
);
...
_sfc_main.__scopeId = "data-v-BottomUpLetters";
const __style = "\n.bottom-up-letters[data-v-BottomUpLetters] {\n  display: inline-block;\n  white-space: pre;\n}\n.bottom-up-letters[data-v-BottomUpLetters] span {\n  display: inline-block;\n  will-change: transform, opacity, filter;\n}\n";
if (typeof document !== "undefined" && !document.getElementById("data-v-BottomUpLetters")) {
  const __styleEl = document.createElement("style");
  __styleEl.id = "data-v-BottomUpLetters";
