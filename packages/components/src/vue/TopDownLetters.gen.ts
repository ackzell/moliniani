...
import { TOP_DOWN_LETTERS, resolveEffectKnobs } from "../textEffects";
import { fromState } from "../effectTiming";


const _sfc_main = /*@__PURE__*/_defineComponent({
  __name: 'TopDownLetters',
...
const split = useSplitUnits(
  ...
  () =>
    ({
      [props.split]: { class: `top-down-letters-${props.split}` },
    }) as TextSplitterParams,
  {
    ...
    unit: () => fromState(resolveEffectKnobs(TOP_DOWN_LETTERS, props)),
    ...
    effect: () => ({
      phase: "phase",
      exit: "exit",
      knobs: () => resolveEffectKnobs(TOP_DOWN_LETTERS, props),
