...
import { buildEffectAnimation, SHARED_AXIS_X, type TextEffectProps } from "../textEffects";
...
const _sfc_main = /*@__PURE__*/_defineComponent({
  ...
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...SHARED_AXIS_X.defaults,
    split: SHARED_AXIS_X.target,
    progress: 0,
    fontSize: 32,
...
const anime = useSplitTextAnimation(
  el,
  () => {
    return { [props.split]: { class: `shared-axis-x-${props.split}` } } as TextSplitterParams;
  },
  () => buildEffectAnimation(SHARED_AXIS_X, props as TextEffectProps),
  {
    progress: "progress",
    units: () => props.split as SplitUnitOrWhole,
    text: () => props.text,
    staggerMode: () => SHARED_AXIS_X.staggerMode,
  },
);
...
_sfc_main.__scopeId = "data-v-SharedAxisX";
const __style = "\n.shared-axis-x[data-v-SharedAxisX] {\n  display: inline-block;\n  white-space: pre;\n}\n.shared-axis-x[data-v-SharedAxisX] span {\n  display: inline-block;\n  will-change: transform, opacity, filter;\n}\n";
if (typeof document !== "undefined" && !document.getElementById("data-v-SharedAxisX")) {
  const __styleEl = document.createElement("style");
  __styleEl.id = "data-v-SharedAxisX";
