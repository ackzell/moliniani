...
import { buildEffectAnimation, DEPTH_PARALLAX_WORDS, type TextEffectProps } from "../textEffects";
...
const anime = useSplitTextAnimation(
  ...
  () => buildEffectAnimation(DEPTH_PARALLAX_WORDS, props as TextEffectProps),
  {
    progress: "progress",
