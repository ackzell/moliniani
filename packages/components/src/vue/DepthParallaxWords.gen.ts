...
import { DEPTH_PARALLAX_WORDS, resolveEffectKnobs } from "../textEffects";
import { fromState } from "../effectTiming";


const _sfc_main = /*@__PURE__*/_defineComponent({
  __name: 'DepthParallaxWords',
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...DEPTH_PARALLAX_WORDS.defaults,
    split: DEPTH_PARALLAX_WORDS.target,
    phase: 0,
    exit: 0,
    fontSize: 32,
...
const split = useSplitUnits(
  ...
  () =>
    ({
      [props.split]: { class: `depth-parallax-words-${props.split}` },
    }) as TextSplitterParams,
  {
    ...
    unit: () => fromState(resolveEffectKnobs(DEPTH_PARALLAX_WORDS, props)),
    ...
    effect: () => ({
      phase: "phase",
      exit: "exit",
      knobs: () => resolveEffectKnobs(DEPTH_PARALLAX_WORDS, props),
      staggerMode: () => DEPTH_PARALLAX_WORDS.staggerMode,
