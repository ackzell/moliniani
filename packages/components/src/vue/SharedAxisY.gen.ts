...
import { buildEffectAnimation, SHARED_AXIS_Y, type TextEffectProps } from "../textEffects";
...
const _sfc_main = /*@__PURE__*/_defineComponent({
  ...
  props: /*@__PURE__*/_mergeDefaults({
    ...
    ...SHARED_AXIS_Y.defaults,
    split: SHARED_AXIS_Y.target,
    progress: 0,
    fontSize: 32,
...
const anime = useSplitTextAnimation(
  el,
  () => {
    return { [props.split]: { class: `shared-axis-y-${props.split}` } } as TextSplitterParams;
  },
  () => buildEffectAnimation(SHARED_AXIS_Y, props as TextEffectProps),
  {
    progress: "progress",
    units: () => props.split as SplitUnitOrWhole,
    text: () => props.text,
    staggerMode: () => SHARED_AXIS_Y.staggerMode,
  },
);
...
_sfc_main.__scopeId = "data-v-SharedAxisY";
const __style = "\n.shared-axis-y[data-v-SharedAxisY] {\n  display: inline-block;\n  white-space: pre;\n}\n.shared-axis-y[data-v-SharedAxisY] span {\n  display: inline-block;\n  will-change: transform, opacity, filter;\n}\n";
if (typeof document !== "undefined" && !document.getElementById("data-v-SharedAxisY")) {
  const __styleEl = document.createElement("style");
  __styleEl.id = "data-v-SharedAxisY";
